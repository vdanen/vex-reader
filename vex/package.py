    ...
    def build_product_tree(self):
        ...
        for p in self.raw['product_tree']['branches']:
            ...
            for b in p['branches']:
                ...
                elif 'product' in b and 'category' in b:
                    # Handle products at Level 1 that don't have nested branches
                    # These are products themselves (category: product_name or product_version)
